-- Working test user setup with correct table structure
...
BEGIN
  ...
  -- Insert sample saved searches (using 'title' instead of 'name')
  INSERT INTO public.saved_searches (
    user_id, title, source_key, params, created_at
  ) VALUES 
